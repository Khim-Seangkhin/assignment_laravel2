...
@section('content')
    <div class="container mb-5">
        ...
        <hr>
        <p><a href="{{ route('apply_for_it_department.index') }}" class="btn btn-dark btn-sm">Back</a></p>
        <form action="{{ route('apply_for_it_department.update',$ml_request->id) }}" method="POST">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
